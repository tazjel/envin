...
Envin is extensible an environment installation tool for the developers.
...
opportunity to organize source code in any way they like.

Installers
----------

Application installer class is where all installation and configuration
process happens. This class is based on cliff 'Command' class and should be
subclassed. Each subclass should implement 'run' method. It is the main
app installer method that does all work.

Currently Envin supports the following applications:
